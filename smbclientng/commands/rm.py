...
class Command_rm(Command):
    ...
    HELP = {
        "description": [description, "Syntax: 'rm <remote_file>'"],
        "subcommands": [],
    ...
    def setupParser(self) -> CommandArgumentParser:
        ...
        parser.add_argument(
            "path", type=str, nargs="*", help="List of remote files to remove"
        )
        return parser
    ...
    def run(self, interactive_shell, arguments: list[str], command: str):
        ...
        for path_to_file in self.options.path:
            ...
            # File
            elif interactive_shell.sessionsManager.current_session.path_exists(
                path_to_file
            ):
